...
export default function TechFooter({ onNavigate, onPageChange, hideContactForm }: TechFooterProps) {
  ...
  return (
    <div className="w-full font-sans flex flex-col">
      ...
      {/* =========================================
          1. PRE-FOOTER CONTACT FORM (🔥 FIX: Added hide condition here)
      ========================================= */}
      {!hideContactForm && (
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12 mb-16">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm text-slate-300 font-light">
                <li><button onClick={() => onPageChange('services')} className="hover:text-white transition-colors outline-none">Business ERP</button></li>
                <li><button onClick={() => onPageChange('services')} className="hover:text-white transition-colors outline-none">3D Digital Models</button></li>
                <li><button onClick={() => onPageChange('services')} className="hover:text-white transition-colors outline-none">Live IoT Tracking</button></li>
                <li><button onClick={() => onPageChange('services')} className="hover:text-white transition-colors outline-none">Data Security</button></li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm text-slate-300 font-light">
                <li><button onClick={() => onPageChange('industry')} className="hover:text-white transition-colors outline-none">Mega Construction</button></li>
                <li><button onClick={() => onPageChange('industry')} className="hover:text-white transition-colors outline-none">Transport & Ports</button></li>
                <li><button onClick={() => onPageChange('industry')} className="hover:text-white transition-colors outline-none">Defense & Gov</button></li>
                <li><button onClick={() => onPageChange('industry')} className="hover:text-white transition-colors outline-none">Power Grids</button></li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm text-slate-300 font-light">
                <li><button onClick={() => onPageChange('about-us')} className="hover:text-white transition-colors outline-none">About Us</button></li>
                ...
                <li><button onClick={() => onNavigate("infra")} className="hover:text-white transition-colors outline-none">Cestrix Infra Division</button></li>
                <li><button onClick={() => onNavigate("gateway")} className="hover:text-white transition-colors outline-none">Global Gateway</button></li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-white/10 gap-6 text-xs text-slate-400 font-light">
            ...
            <div className="flex gap-6">
              <button onClick={() => onPageChange("privacy")} className="hover:text-white transition-colors outline-none">Privacy Policy</button>
              <button onClick={() => onPageChange("terms")} className="hover:text-white transition-colors outline-none">Terms of Use</button>
              <button onClick={() => onPageChange("disclaimer")} className="hover:text-white transition-colors outline-none">Disclaimer</button>
              <button onClick={() => onPageChange("cookies")} className="hover:text-white transition-colors outline-none">Cookies Policy</button>
            </div>
          </div>
